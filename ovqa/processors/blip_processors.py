...
from ovqa.processors.randaugment import RandomAugment
...
@registry.register_processor("blip_caption_cased")
class BlipCaptionCasedProcessor(BlipCaptionProcessor):
    def pre_caption(self, caption):
        caption = re.sub(
            r"([.!\"()*#:;~])",
            " ",
...
@registry.register_processor("blip_question_cased")
class BlipQuestionCasedProcessor(BlipQuestionProcessor):
    def pre_question(self, question):
        question = re.sub(
            r"([.!\"()*#:;~])",
            "",
