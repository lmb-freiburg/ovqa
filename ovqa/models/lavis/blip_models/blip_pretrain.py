...
from ovqa.models.lavis.base_model import MomentumDistilationMixin, SharedQueueMixin
from ovqa.models.lavis.blip_models import tie_encoder_decoder_weights
...
class BlipPretrain(BlipBase, SharedQueueMixin, MomentumDistilationMixin):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "base": "ovqa/configs/lavis_models/other/blip_pretrain_base.yaml",
        # "large": "ovqa/configs/lavis_models/other/blip_pretrain_large.yaml",
    }
    ...
    def forward(self, samples):
        ...
        Returns:
            BlipOutput: A BlipOutput object containing loss and intermediate output. See ``ovqa.models.lavis.blip_models.blip_outputs.BlipOutput`` for more details.
