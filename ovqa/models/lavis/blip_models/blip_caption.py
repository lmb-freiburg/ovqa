...
class BlipCaption(BlipBase):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "base_coco": "ovqa/configs/lavis_models/other/blip_caption_base_coco.yaml",
        "large_coco": "ovqa/configs/lavis_models/other/blip_caption_large_coco.yaml",
    }
        ...
        Returns:
            output (BlipOutput): A BlipOutput object containing the following
                ...
                - intermediate_outputs (BlipIntermediateOutput): A BlipIntermediateOutput object containing intermediate outputs.
                  see :class:`ovqa.models.lavis.blip_models.blip_outputs.BlipOutput` for more details.

        Example:
        ```python
        >>> from PIL import Image
        >>> from ovqa.models import load_model_and_preprocess
