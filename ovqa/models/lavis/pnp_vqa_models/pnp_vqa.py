...
from ovqa.models.lavis.pnp_vqa_models import prepare_qa_input
...
class PNPVQA(BaseModel):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "base": "ovqa/configs/lavis_models/pnp-vqa/pnp_vqa_base.yaml",
        "large": "ovqa/configs/lavis_models/pnp-vqa/pnp_vqa_large.yaml",
        "3b": "ovqa/configs/lavis_models/pnp-vqa/pnp_vqa_3b.yaml",
    }
    ...
    def forward_cap(
        ...
        while min_num_captions < num_captions:
            ...
            for i in range(num_captions):
                ...
                patch_id = (
                    patch_id.sort(dim=1).values.unsqueeze(-1).expand(-1, -1, encoder_out.size(2))
                )
