...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            # avoid the below code that turns "none" into "sum" reduction, without changing behavior
            ce_reduction = reduction
            if reduction == "none_keep_sequence":
                ce_reduction = "none"

            loss_fct = CrossEntropyLoss(ignore_index=-100, reduction=ce_reduction)
