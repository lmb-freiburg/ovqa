...
class Blip2T5Instruct(Blip2Base):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "flant5xl": "ovqa/configs/lavis_models/blip2/blip2_instruct_flant5xl.yaml",
        "flant5xxl": "ovqa/configs/lavis_models/blip2/blip2_instruct_flant5xxl.yaml",
    }
    ...
    def predict_answers(
        ...
        **kwargs,
        ...
        # remove using  "ocr_tokens" and "samples", see original code file
    ...
    def generate(
        ...
        **kwargs,
        ...
        self.emit_debug_message(
            text_input, input_tokens.input_ids, self.t5_tokenizer, generation_kwargs, kwargs
        )
    ...
    def old_generate(
        ...
        if image.dim() == 5:
            ...
            for j in range(image.size(2)):
                ...
                frame_atts_t5 = torch.ones(frame_inputs_t5.size()[:-1], dtype=torch.long).to(
                    image.device
                )
        ...
        input_tokens = self.t5_tokenizer(prompt, padding="longest", return_tensors="pt").to(
            image.device
        )
    ...
    def _predict_class(
        ...
        output_tokens = self.t5_tokenizer(candidates, padding="longest", return_tensors="pt").to(
            image.device
        )
