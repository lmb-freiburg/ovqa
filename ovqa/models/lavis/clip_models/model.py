...
from ovqa.common.lavis.utils import get_abs_path
from ovqa.models.lavis.base_model import BaseModel
from ovqa.models.lavis.clip_models.clip_outputs import ClipOutput, ClipOutputFeatures
from ovqa.models.lavis.clip_models.timm_model import TimmModel
from ovqa.models.lavis.clip_models.transform import image_transform
from ovqa.models.lavis.clip_models.utils import freeze_batch_norm_2d
...
_MODEL_CONFIG_PATHS = [Path(__file__).parent.parent.parent / f"ovqa/configs/lavis_models/clip/"]
...
class CLIP(BaseModel):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "ViT-B-32": "ovqa/configs/lavis_models/other/clip_vit_base32.yaml",
        "ViT-B-16": "ovqa/configs/lavis_models/other/clip_vit_base16.yaml",
        "ViT-L-14": "ovqa/configs/lavis_models/other/clip_vit_large14.yaml",
        "ViT-L-14-336": "ovqa/configs/lavis_models/other/clip_vit_large14_336.yaml",
        "RN50": "ovqa/configs/lavis_models/other/clip_resnet50.yaml",
    }
    ...
    def __init__(
        ...
        # Tamplates moved to lavis/tasks/multimodal_classification.py as a function
    ...
    def loss(self):
        if self._loss is None:
            from ovqa.models.lavis.clip_models.loss import ClipLoss
    ...
    def zero_shot_predict(self, image_path, categories):
        ...
        from ovqa.processors.clip_processors import ClipImageEvalProcessor
