...
class Img2PromptVQA(BaseModel):
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "base": "ovqa/configs/lavis_models/img2prompt-vqa/img2prompt_vqa_base.yaml",
    }
    ...
    def __init__(
        ...
        self.nlp = maybe_download_spacy_model("en_core_web_sm")
    ...
    def itm_rank(self, image_embeds, image_atts, encoder_input_ids, match_head="itm"):
        ...
        text_attention_mask = (encoder_input_ids != self.tokenizer.pad_token_id).long()  # noqa
