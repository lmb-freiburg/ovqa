...
from ovqa.models.x2vlm.xvlm import XVLMBase, XVLMPlusBase
...
class XVLM(XVLMBase):
    ...
    def forward_text(
        self, text_ids=None, text_atts=None, text_ids_masked=None, masked_pos=None, masked_ids=None
    ):
...
class CrossViewLM(XVLMPlus):  # Multilingual x Multimodal Pre-training
    ...
    def forward_para_text(
        self,
        text_ids=None,
        text_atts=None,
        text_ids_masked=None,
        text_atts_masked=None,
        masked_pos=None,
        masked_ids=None,
        text_ids_2=None,
        text_atts_2=None,
        text_ids_masked_2=None,
        masked_pos_2=None,
        masked_ids_2=None,
    ):
        text_embeds = self.get_text_embeds(text_ids, text_atts)
        ...
        loss_ttm = self.get_matching_loss(
            text_embeds, text_atts, text_feat, text_embeds_2, text_atts_2, text_feat_2
        )

        loss_mlm = self.get_mlm_loss(
            text_ids_masked, text_atts, text_embeds_2, text_atts_2, masked_pos, masked_ids
        )
