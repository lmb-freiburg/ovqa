...
from ovqa.metrics.bleurt_pytorch.bleurt.tokenization_bleurt_fast import (
    BleurtTokenizerFast,
)  # noqa: E402
from ovqa.metrics.bleurt_pytorch.bleurt.tokenization_bleurt_sp import (
    BleurtSPTokenizer,
)  # noqa: E402
...
def main(args: Namespace):
    ...
    with torch.no_grad():
        res = (
            model(**tok(references, candidates, padding="longest", return_tensors="pt"))
            .logits.flatten()
            .numpy()
        )
