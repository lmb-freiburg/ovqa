...
from ovqa.metrics.lerc.allennlp.common.lazy import Lazy
...
def is_base_registrable(cls) -> bool:
    ...
    a class.
    """
    from ovqa.metrics.lerc.allennlp.common.registrable import (
        Registrable,
...
def pop_and_construct_arg(
    ...
    """
    from ovqa.metrics.lerc.allennlp.archival import (
        load_archive,
    )  # import here to avoid circular imports
