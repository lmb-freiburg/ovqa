...
from ovqa.metrics.lerc.allennlp.common.file_utils import cached_path, FileLock
from ovqa.metrics.lerc.allennlp.common.registrable import Registrable
from ovqa.metrics.lerc.allennlp.common.util import namespace_match

if TYPE_CHECKING:
    from ovqa.metrics.lerc.allennlp import instance as adi
