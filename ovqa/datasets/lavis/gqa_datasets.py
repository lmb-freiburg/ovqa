...
from ovqa.datasets.lavis.vqa_datasets import VQADataset, VQAEvalDataset
from packg.iotools import load_json


class __DisplMixin:
    def displ_item(self, index):
        sample, ann = self.__getitem__(index), self.annotation[index]  # noqa
...
class GQAEvalDataset(VQAEvalDataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths, config):
        ...
        self.annotation = load_json(ann_paths[0])
